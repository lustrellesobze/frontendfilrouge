...
export default function ProgramManagerReports() {
  ...
  const loadReports = async () => {
    try {
      ...
      const res = await api.get(`/program-manager/reports?${params.toString()}`);
      setData(res.data);
    } catch (e) {
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-600 mb-6">
          Consultez les rapports des candidatures et paiements de votre (vos) filière(s) par période.
        </p>
          ...
          <div className="flex flex-wrap items-end gap-4">
            <div>
              ...
              <select
                ...
                className="w-full min-w-[200px] px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
              >
                {PERIODS.map((p) => (
              ...
              <>
                <div>
                  ...
                  <select
                    ...
                    className="w-full min-w-[140px] px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  >
                    {MONTHS.map((m) => (
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full min-w-[100px] px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  >
                    {YEARS.map((y) => (
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-indigo-50 rounded-lg p-4 border border-indigo-100">
                  <div className="text-2xl font-bold text-indigo-700">{data.enrollments?.total ?? 0}</div>
